...
class Pulsar(Orbit):
    ...
    # type annotations for commonly set runtime attributes
    gl: Optional[float] = None
    gb: Optional[float] = None
    t_scatter: Optional[float] = None
    r0: Optional[float] = None
    def __init__(self,
                 period=None,
                 pdot:Optional[float]=None,
                 dm=None,
                 gl:Optional[float]=None,
                 gb:Optional[float]=None,
                 galCoords=None,
        ...
        # normalize galactic longitude into (-180, 180] and handle None
        if gl is None:
            norm_gl = None
        else:
            try:
    ...
    def efficiency(self):
        ...
        edot = self.edot()
        # Need both edot and luminosity defined to compute efficiency
        if edot is None or self.lum_1400 is None:
            return None
    ...
    def edot(self):
        ...
        # Need both pdot and period defined
        if self.pdot is None or self.period is None:
            return None

        pdot_15 = self.pdot * 1.0E15
        return 3.95E31 * pdot_15 / (self.period/1000.0)**3
